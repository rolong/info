...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      ...
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0x5411195606b23a2c1e14222bf9a8d6fa9a1296a0' ? 'CRC' : token0Address}/${'CRC'}`
    )
  } else {
    return (
      `https://swap.crcchainpro.com/#/` +
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0x5411195606b23a2c1e14222bf9a8d6fa9a1296a0' ? 'CRC' : token0Address}/${token1Address === '0x5411195606b23a2c1e14222bf9a8d6fa9a1296a0' ? 'CRC' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    ...
    return `https://swap.crcchainpro.com/#/swap?inputCurrency=${token0Address === '0x5411195606b23a2c1e14222bf9a8d6fa9a1296a0' ? 'CRC' : token0Address
      }&outputCurrency=${token1Address === '0x5411195606b23a2c1e14222bf9a8d6fa9a1296a0' ? 'CRC' : token1Address}`
  }
}

export function getMiningPoolLink(token0Address) {
  return `https://swap-n168.crcchainpro.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://swap-n168.crcchainpro.com/#/uni'
  if (!linkVariable) {
...
export const urls = {
  showTransaction: (tx) => `https://crcchainpro.com/tx/${tx}/`,
  showAddress: (address) => `https://www.crcchainpro.com/address/${address}/`,
  showToken: (address) => `https://www.crcchainpro.com/token/${address}/`,
  showBlock: (block) => `https://crcchainpro.com/block/${block}/`,
}
