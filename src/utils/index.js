...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      `https://swap-nx-discoveryfield.cncchainpro.com/#/` +
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0xbfb7f520772feb3216c953821365f648c8f66c2b' ? 'CNC' : token0Address}/${'CNC'}`
    )
  } else {
    return (
      `https://swap-nx-discoveryfield.cncchainpro.com/#/` +
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0xbfb7f520772feb3216c953821365f648c8f66c2b' ? 'CNC' : token0Address}/${token1Address === '0xbfb7f520772feb3216c953821365f648c8f66c2b' ? 'CNC' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://swap-nx-discoveryfield.cncchainpro.com/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://swap-nx-discoveryfield.cncchainpro.com/#/swap?inputCurrency=${token0Address === '0xbfb7f520772feb3216c953821365f648c8f66c2b' ? 'CNC' : token0Address
      }&outputCurrency=${token1Address === '0xbfb7f520772feb3216c953821365f648c8f66c2b' ? 'CNC' : token1Address}`
  }
}

export function getMiningPoolLink(token0Address) {
  return `https://swap-nx-discoveryfield.cncchainpro.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://swap-nx-discoveryfield.cncchainpro.com/#/uni'
  if (!linkVariable) {
