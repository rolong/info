...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      `https://swap-nx-pro.cncchainpro.com/#/` +
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0x36fd86f238bfbc5dc6da58ae0ed4e8b14868e30c' ? 'CNC' : token0Address}/${'CNC'}`
    )
  } else {
    return (
      `https://swap-nx-pro.cncchainpro.com/#/` +
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0x36fd86f238bfbc5dc6da58ae0ed4e8b14868e30c' ? 'CNC' : token0Address}/${token1Address === '0x36fd86f238bfbc5dc6da58ae0ed4e8b14868e30c' ? 'CNC' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://swap-nx-pro.cncchainpro.com/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://swap-nx-pro.cncchainpro.com/#/swap?inputCurrency=${token0Address === '0x36fd86f238bfbc5dc6da58ae0ed4e8b14868e30c' ? 'CNC' : token0Address
      }&outputCurrency=${token1Address === '0x36fd86f238bfbc5dc6da58ae0ed4e8b14868e30c' ? 'CNC' : token1Address}`
  }
}

export function getMiningPoolLink(token0Address) {
  return `https://swap-nx-pro.cncchainpro.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://swap-nx-pro.cncchainpro.com/#/uni'
  if (!linkVariable) {
