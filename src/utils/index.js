...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      ...
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0x26246de7420e8be3a865886e9c5f0c962b302c96' ? 'CRC' : token0Address}/${'CRC'}`
    )
  } else {
    return (
      `https://swap.crcchainpro.com/#/` +
      (remove ? `remove` : `add`) +
      `/v2/${token0Address === '0x26246de7420e8be3a865886e9c5f0c962b302c96' ? 'CRC' : token0Address}/${token1Address === '0x26246de7420e8be3a865886e9c5f0c962b302c96' ? 'CRC' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    ...
    return `https://swap.crcchainpro.com/#/swap?inputCurrency=${token0Address === '0x26246de7420e8be3a865886e9c5f0c962b302c96' ? 'CRC' : token0Address
      }&outputCurrency=${token1Address === '0x26246de7420e8be3a865886e9c5f0c962b302c96' ? 'CRC' : token1Address}`
  }
}

export function getMiningPoolLink(token0Address) {
  return `https://swap-n5.crcchainpro.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://swap-n5.crcchainpro.com/#/uni'
  if (!linkVariable) {
