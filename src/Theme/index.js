...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#FF9500' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#FF9500',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#FF9500',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#FF9500',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #FF950030 0%, #fff 0%)`,
})
