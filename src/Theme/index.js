...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#FDBD23' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#FDBD23',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#FDBD23',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#FDBD23',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #FDBD2330 0%, #fff 0%)`,
})
